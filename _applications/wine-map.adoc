...
....
oc describe route winemap
....

If you look at the following screenshot you can see that the route is shown by the attribute "Requested Host", copy this into your browser and the map should be displayed.

pass:[<img src="/assets/wine-map/route.png" alt="Route" class="img-responsive" width="700" height="400">]
