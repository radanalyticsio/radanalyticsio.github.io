...
These provide the OpenJDK image stream for the data-publisher service, the radanalytics.io Oshinko resources for facilitating Spark cluster creation and deployment, and the Infinispan template for the caching microservice, respectively. 
