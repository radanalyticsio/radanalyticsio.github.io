...
The MNIST digit identification application provides an example of how to use https://github.com/openshift/source-to-image[source-to-image] to build to deploy a tensorflow prediction endpoint on Openshift.
