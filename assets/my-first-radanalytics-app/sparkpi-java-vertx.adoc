...
The first file you will create in that directory is named `sparkpi.properties` and it should contain the following contents:
...
src/main/resources/sparkpi.properties
....
