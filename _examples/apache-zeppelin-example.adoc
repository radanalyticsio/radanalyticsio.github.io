...
will connect to the Spark cluster managed by the ochinko project and run some analysis. This
...
are pyspark). You can run individually each paragraphs or you can click on the `Run all 
